...
class Logger(object):
    def __init__(self, log_configs=True):
        ...
        target_dataset_name = configs['target_data']['name']
        if not configs['tune']['enable']:
            log_file = logging.FileHandler('{}/{}_{}_{}.log'.format(log_dir_path, dataset_name,target_dataset_name, get_local_time()), 'a', encoding='utf-8')
        else:
    ...
    def log_eval(self, eval_result, k, data_type, save_to_log=True, print_to_console=True, epoch_idx=None,auc=None):
